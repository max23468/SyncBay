...
- [x] **Step 1: Scrivere test failing per corsia docs-only, fallback full, deduplica, serialità e fingerprint**
...
- [x] **Step 3: Implementare il minimo orchestratore**
...
- [x] **Step 4: Aggiungere script npm raw e pubblici**
...
- [x] **Step 1: Scrivere test failing per node_modules assente, lock mismatch e Prisma mancante**
...
- [x] **Step 3: Implementare controlli read-only**
...
- [x] **Step 4: Verificare GREEN e CLI reale**
...
- [x] **Step 1: Scrivere test failing sul numero di letture remote**
...
- [x] **Step 3: Implementare la lettura direct-first**
...
- [x] **Step 3: Implementare workflow minimali**
...
- [x] **Step 1: Aggiungere stop condition durevoli**
...
- [x] **Step 2: Aggiungere `app/services/AGENTS.md`**
...
- [x] **Step 3: Aggiornare toolchain e changelog non versionato**
...
- [x] **Step 4: Verificare documentazione**
...
- [x] **Step 1: Eseguire test script mirati**
