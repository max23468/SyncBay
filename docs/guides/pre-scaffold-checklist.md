...
- [x] Webhook minimi configurati nello scaffold come placeholder tracciati; `orders/paid` resta route preparata ma non sottoscritta finché Shopify protected customer data non viene approvato.
