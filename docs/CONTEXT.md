...
- Prisma: ORM 7.8 con adapter Postgres.
...
- Stock eBay da ordini Shopify: la custom app privata riceve `orders/paid` e crea
  ...
  candidati. La sessione offline dello store pilota Numisleo include `write_orders`; per
...
- Faccette storefront importate: `decisions/0016-faccette-storefront-import.md`
