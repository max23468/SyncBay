...
- Preview import: live via Inventory API per offer pubblicate, poi fallback Trading API `GetMyeBaySelling` in sola lettura per listing attivi storici/Seller Hub.
