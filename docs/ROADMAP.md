...
| In corso | Import iniziale fino a 2.000 prodotti | Batch 50 verificato con import Shopify idempotente; l'ultimo job reale ha gestito 50 listing con 26 nuove bozze e 24 riusi senza duplicati. L'import controllato registra mapping, snapshot, job e audit, usa `Pubblicato` come default per i nuovi import e consente `Bozza` da Impostazioni. Resta espandere copertura fino al limite MVP |
