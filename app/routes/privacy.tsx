    ...
    <AppProvider embedded={false}>
      <s-page heading="Informativa privacy SyncBay">
        ...
        <s-section heading="SyncBay">
          <s-stack gap="base">
            ...
            <s-text>
              ...
              ufficiale eBay o Shopify. L&apos;app collega un negozio Shopify a
              un account eBay.it per importare, collegare e sincronizzare dati
              di catalogo, disponibilità e informazioni operative necessarie al
              servizio.
            </s-text>
          </s-stack>
        </s-section>
        ...
        <s-section heading="Quali dati tratta">
          <s-stack gap="base">
            <s-text>
              L&apos;app può trattare dati tecnici dello shop Shopify, dati
              account e catalogo eBay, dati catalogo Shopify, immagini, SKU,
              prezzi, quantità, stato prodotto, canali di pubblicazione e
        ...
        <s-section heading="Come vengono usati">
          <s-text>
            ...
            disponibili, mostrare diagnostica, aprire conflitti quando Shopify
            diverge dall&apos;ultimo valore scritto da SyncBay e gestire errori,
            revoche, disinstallazioni e richieste provider come eBay marketplace
            account deletion.
          </s-text>
        </s-section>
        ...
        <s-section heading="Sicurezza">
          <s-stack gap="base">
            ...
            <s-text>
              ...
              restano server-side nel perimetro 1.0 privata. SyncBay non espone
              questi dati a client pubblici senza policy esplicite.
            </s-text>
          </s-stack>
        </s-section>
        ...
        <s-section heading="Contatto">
          <s-stack gap="base">
            <s-text>
              Per richieste privacy, revoca, disinstallazione o rimozione dati
              nella 1.0 privata, contattare il maintainer del progetto SyncBay.
            </s-text>
