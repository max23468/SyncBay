    ...
    <AppProvider embedded={false}>
      <s-page heading="Termini SyncBay">
        ...
        <s-section heading="Servizio">
          <s-stack gap="base">
            ...
            <s-text>
              ...
              include billing pubblico e non è una soluzione ufficiale eBay o
              Shopify.
            </s-text>
          </s-stack>
        </s-section>
        ...
        <s-section heading="Fonte di verità eBay">
          <s-text>
            Nel perimetro 1.0, eBay.it è la sorgente principale del catalogo.
            SyncBay può aggiornare Shopify con dati eBay presenti e validi. Se
            un dato eBay è assente, vuoto, non leggibile o non affidabile,
            SyncBay deve segnalarlo come eccezione invece di cancellare dati
            Shopify validi.
          </s-text>
        </s-section>
        ...
        <s-section heading="Errori, conflitti e verifica">
          <s-text>
            SyncBay non deve sovrascrivere silenziosamente modifiche manuali
            Shopify. Divergenze su mapping, prezzo, disponibilità, descrizioni,
            immagini, categorie o tag possono generare conflitti o eccezioni da
            rivedere. Il go-live di un takeover resta bloccato da conflitti
        ...
        <s-section heading="Sospensione o disinstallazione">
          <s-text>
            Il maintainer o il negoziante possono sospendere il sync automatico,
            disattivare la vecchia app di sync secondo il runbook concordato o
            disinstallare SyncBay. In caso di disinstallazione o richiesta di
            revoca, SyncBay gestisce dati e token secondo la privacy policy e le
            decisioni tecniche di retention.
          </s-text>
        </s-section>
        ...
        <s-section heading="Contatto">
          <s-stack gap="base">
            <s-text>
              Per richieste operative, sicurezza, privacy o sospensione del
              servizio nella 1.0 privata, contattare il maintainer del progetto
              SyncBay.
            </s-text>
