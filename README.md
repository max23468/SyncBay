...
1. Verificare sul dev store un import pianificato oltre 50 listing, fino al totale disponibile o al limite MVP di 2.000 prodotti.
2. Aggiungere stato avanzamento import più granulare in dashboard.
