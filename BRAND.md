...
- una suite marketplace enorme;
- un gestionale ecommerce generico;
- un'app che copia o imita i brand eBay o Shopify;
- un tool tecnico solo per sviluppatori;
- un servizio che richiede supporto umano continuo.
...
- nomina eBay e Shopify, ma come contesto naturale e non come imitazione dei brand;
...
- Shopify app per trasformare un negozio eBay.it in un catalogo Shopify sincronizzato.
...
- richiamo sottile ma riconoscibile a eBay.it come punto di partenza;
- Shopify come catalogo ordinato e controllato;
...
- affidabile;
- pratico;
- orientato al negoziante;
- trasparente sugli errori.

Non deve sembrare:

- rumoroso;
- aggressivo;
- troppo "growth hacking";
- troppo enterprise;
- troppo tecnico;
- ansioso o allarmista.
...
- frasi brevi;
- verbi concreti;
- niente esclamativi multipli;
- niente emoji nella UI;
- niente "Oops";
- niente promesse assolute non garantite.
...
- Il negozio eBay resta la fonte principale.
- Shopify riceve un catalogo pulito e vendibile.
- Sincronizzazione entro 5 minuti come garanzia base.
- Real-time dove possibile e sostenibile.

## Visual direction

### Principi

- Interfaccia SaaS operativa, non marketing decorativo.
- Layout denso ma leggibile.
- Dashboard da lavoro quotidiano, non hero page generica.
- Colori sobri con accenti funzionali.
- Richiamo cromatico a eBay/Shopify controllato: riconoscibile, ma non ufficiale o imitativo.
- Evitare gradienti dominanti, orbs, bokeh o decorazione astratta.
...
Logo approvato: **Catalog Bridge**.

Composizione:

- icona a ponte con stanghette verticali sopra;
- `Sync` in verde;
- `Bay` in blu;
- ponte in blu;
- stanghette solo verdi, gialle e rosse;
- tagline sotto al combinato principale.

Asset:

- riferimento approvato: `brand/assets/source/syncbay-logo-approved-reference.png`;
- SVG con tagline: `brand/assets/svg/syncbay-logo-horizontal-tagline.svg`;
- logo orizzontale senza tagline: `brand/assets/svg/syncbay-logo-horizontal.svg`;
...
- logo SVG;
- favicon/app icon;
- export PNG ad alta definizione;
- combinati orizzontali e verticali;
- icona quadrata solo ponte;
- varianti PNG con sfondo trasparente e bianco.

Asset futuri prima del listing pubblico:

- screenshot dashboard;
- screenshot onboarding;
- screenshot conflitti/errori;
- eventuale one-pager App Store.
